...
/*
Class for calculating recommended products for currently logged in user.

This class runs in the background every time the app is opened.
 */
public class ProductRecommendationRunnable implements Runnable {
    ...
    public void run() {
        ...
        /*
        Loading data from database in necessary format.
                                            ...
                                            public void onComplete(@NonNull Task<QuerySnapshot> task) {
                                                if (task.isSuccessful()) {
                                                    ...
                                                    for (QueryDocumentSnapshot document : task.getResult()) {
                                                        ...
                                                        if (map.size() >= 2) {
                                                            /*
                                                            Adding calculated products to the database.
                                                             */
    ...
    /*
    Function for calculating product correlation using rating scores each user added to each product.

     Uses Pearson Correlation score to calculate correlation between products.
     */
    ...
    /*
    Implementing above declared function for calculate recommended products for given user.
     */
    ...
    */
    ...
    /*
    Method for sorting a map for given logic.
     */
